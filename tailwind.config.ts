  ...
  theme: {
    extend: {
      colors: {
        ...
        copper: "#A85D33",   // נחושת - חתימת המותג לקטגוריות, hover, מספור
        oliveDeep: "#3F4A34", // ירוק זית כהה - עומק, קווים בוטניים
        warmWhite: "#FCFAF6", // לבן חם - משטח כרטיס עדין (לא לבן קליני)
